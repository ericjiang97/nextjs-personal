...
/**
 * Content for Food Review documents
 */
interface FoodreviewsDocumentData {
	/**
	 * Restaurant Name field in *Food Review*
	 *
	 * - **Field Type**: Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: foodreviews.name
	 * - **Tab**: Main
	 * - **Documentation**: https://prismic.io/docs/fields/text
	 */
	...
	/**
	 * rating field in *Food Review*
	 *
	 * - **Field Type**: Number
	 * - **Placeholder**: *None*
	 * - **API ID Path**: foodreviews.rating
	 * - **Tab**: Main
	...
	/**
	 * review_date field in *Food Review*
	 *
	 * - **Field Type**: Date
	 * - **Placeholder**: *None*
	 * - **API ID Path**: foodreviews.review_date
	 * - **Tab**: Main
	...
	/**
	 * price_range field in *Food Review*
	 *
	 * - **Field Type**: Select
	 * - **Placeholder**: *None*
	 * - **Default Value**: $ (A$0-$10)
	 * - **API ID Path**: foodreviews.price_range
	 * - **Tab**: Main
	 * - **Documentation**: https://prismic.io/docs/fields/select
	 */
	price_range: prismic.SelectField<"$ (A$0-$10)" | "$$ (A$10-50)" | "$$$ (A$50 - $100)" | "$$$$ (A$100+)", "filled">;
	
	/**
	 * image field in *Food Review*
	 *
	 * - **Field Type**: Image
	 * - **Placeholder**: *None*
	 * - **API ID Path**: foodreviews.image
	 * - **Tab**: Main
	 * - **Documentation**: https://prismic.io/docs/fields/image
	 */
	...
	/**
	 * review field in *Food Review*
	 *
	 * - **Field Type**: Rich Text
	 * - **Placeholder**: *None*
	 * - **API ID Path**: foodreviews.review
	 * - **Tab**: Main
	 * - **Documentation**: https://prismic.io/docs/fields/rich-text
	 */
	...
	/**
	 * maps_url field in *Food Review*
	 *
	 * - **Field Type**: Link
	 * - **Placeholder**: *None*
	 * - **API ID Path**: foodreviews.maps_url
	 * - **Tab**: Main
	 * - **Documentation**: https://prismic.io/docs/fields/link
	 */
	maps_url: prismic.LinkField<string, string, unknown, prismic.FieldState, never>;
}

/**
 * Food Review document from Prismic
 *
 * - **API ID**: `foodreviews`
 * - **Repeatable**: `true`
 * - **Documentation**: https://prismic.io/docs/content-modeling
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type FoodreviewsDocument<Lang extends string = string> = prismic.PrismicDocumentWithUID<Simplify<FoodreviewsDocumentData>, "foodreviews", Lang>;
...
export type AllDocumentTypes = AlbumDocument | BlogPostDocument | CategoryDocument | FoodreviewsDocument | HomepageDocument | TagDocument | TechTalkDocument;
