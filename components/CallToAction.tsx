    ...
    <div className="w-full">
      <div className="max-w-4xl mx-auto py-auto p-8 flex flex-row flex-wrap justify-around">
        <div className="flex-1 mx-auto py-auto flex flex-col justify-start mr-4" style={{ minWidth: 280 }}>
          <h3 className="m-0 text-brand text-xl font-semibold">Currently helping battle the spread of COVID-19.</h3>
          <h3 className="mt-2 text-sm ">I'm working on a few open source projects at the moment, you can too.</h3>
        </div>
